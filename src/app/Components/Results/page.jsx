...
export default function ResultDashBoard({ product }) {
  return (
    <>
      <motion.div
        key={product.id}
      ...
      >
        <div className="flex flex-col w-[270px] h-[425px] p-4 bg-gray-100 rounded-lg relative shadow-md">
          <Link passHref href={`/Components/ProductOverView/${product.id}`}>
            <div className="relative w-full overflow-hidden duration-300 ease-in-out bg-orange-200 rounded-lg h-44 hover:rotate-2">
              <img
